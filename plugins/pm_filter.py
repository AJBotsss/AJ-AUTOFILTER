...
async def pm_text(bot, message):
    ...
    await message.reply_text(
         ...
         reply_markup=InlineKeyboardMarkup([[InlineKeyboardButton("📝 ʀᴇǫᴜᴇsᴛ ʜᴇʀᴇ ", url=f"https://t.me/+UIq6GethUsRiNGE1")]])
    )
...
async def cb_handler(client: Client, query: CallbackQuery):
    ...
    if query.data.startswith("file"):
        ...
        btn2 = [[
                 ...
                 InlineKeyboardButton("Rᴇᴏ̨ᴜᴇsᴛ Gʀᴏᴜᴘ Lɪɴᴋ", url="https://t.me/+UIq6GethUsRiNGE1")
               ]]
        if query.from_user.id in ADMINS:
            user = await client.get_users(from_user)
            reply_markup = InlineKeyboardMarkup(btn)
    ...
    # don't change anything without contacting me @creatorrio
        ...
        buttons = [[
            InlineKeyboardButton('🫵 Buy Subscription 🫵', url="https://t.me/TKORIGINALSPAYMENBOT"),
        ],[
            InlineKeyboardButton('🍀 Movie Search Group 🍀', url="https://t.me/+UIq6GethUsRiNGE1")
        ],[
            InlineKeyboardButton('🍂 Movie channel 🍂', url="https://t.me/+qvKHwpYrxYQ1YmU9")
        ],[
            InlineKeyboardButton('🍁 Bots Update Channel 🍁', url="https://t.me/AJBOTS2")
        ],[
        ...
        await query.message.edit_text(
            ...
            btn = [[
                    InlineKeyboardButton("⟸ Bᴀᴄᴋ", callback_data="help"),
                    InlineKeyboardButton("Cᴏɴᴛᴀᴄᴛ", url="telegram.me/SSA_TG")
                  ]]
            await client.edit_message_media(
                query.message.chat.id, 
                query.message.id, 
